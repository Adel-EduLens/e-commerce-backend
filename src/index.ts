...
// All product types (SHOP, RETAIL, WHOLESALE, BLANK) are served from /api/products
// Use ?type=SHOP|RETAIL|WHOLESALE|BLANK to filter
app.use('/api/products', productRouter)

// ── Unified Category System ──
// Use ?type=SHOP|RETAIL|WHOLESALE|BLANK to filter by product type
